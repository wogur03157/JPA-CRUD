...
//                member.setName(paymentResHandleDto.getName());
    ...
    @Transactional
    public ResponseEntity easycardPayments(EasyCardPaymentDto easyCardPaymentDto) throws Exception {
        try {
            System.out.println("easycardPayments");
            Orders orders = easyCardPaymentDto.toOrderBuilder();
            orderRepository.save(orders);
